...
ORB2_SUB_MK:=$(call my-dir)/ORB2-$(TARGET_ARCH_ABI).mk
...
include C:/Users/bouviervj/opencv-3.3.0-android-sdk/OpenCV-android-sdk/sdk/native/jni/OpenCV.mk
else  
...
LOCAL_EXPORT_C_INCLUDES+=C:/Users/bouviervj/opencv-3.3.0-android-sdk/OpenCV-android-sdk/sdk/native/jni/include
LOCAL_PATH:=$(MAIN_DIR)
include $(BUILD_SHARED_LIBRARY)
###############################################################
